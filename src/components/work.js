  ...
  return (
    <Row xs={1} id="work">
      <Col style={{ maxWidth: "800px" }}>
        ...
        <span className="chevron left" onClick={()=>{if(index>0){setIndex(index-1)}}}/>
        <span className="chevron right" onClick={()=>{if(index<total-1){setIndex(index+1)}}}/>
        {index === 0 && (
          <>
            <img
        ...
        {index === 2 && (
          <>
            ...
            <p classname="imgpar">
              ...
              Can be played with a keyboard, as well as a custom controller.<br/>
